...
1. [1. Exception Types](#1-exception-types)
   - [1.1 Predefined Exceptions](#11-predefined-exceptions)
   - [1.2 User-Defined Exceptions](#12-user-defined-exceptions)
2. [2. Exception Handling Block](#2-exception-handling-block)
3. [3. Exception Propagation](#3-exception-propagation)
4. [4. SQLCODE and SQLERRM](#4-sqlcode-and-sqlerrm)
   - [4.1 SQLCODE](#41-sqlcode)
   - [4.2 SQLERRM](#42-sqlerrm)
5. [5. RAISE_APPLICATION_ERROR](#5-raise_application_error)
